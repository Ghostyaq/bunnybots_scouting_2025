...
select = 449
data <- raw|>
select(teleop_preshutdown_high_lunites_scored,teleop_preshutdown_low_lunites_scored,teleop_preshutdown_lunites_missed,teleop_preshutdown_lunites_passed,teleop_postshutdown_high_lunites_scored,teleop_postshutdown_low_lunites_scored,teleop_postshutdown_lunites_missed,teleop_postshutdown_lunites_passed)|>
...
summarize(
    ...
    tp_postshut_highls = mean(teleop_postshutdown_high_lunites_scored),
    tp_postshut_lowls = mean(teleop_postshutdown_low_lunites_scored),
    tp_postshut_lmiss = mean(teleop_postshutdown_lunites_missed),
    tp_postshut_lpass = mean(teleop_preshutdown_lunites_passed)
)|>
